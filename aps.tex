...
fiducial for the quadcopter. Such a fiducial is required for tracking objects by
a quadcopter. After finding a possible solution for the tracking problem, we are
using quadcopter for actual imaging and developing applications based on it.
...
stitched those images to get final mosaic. Panoramic image stitching
...
very difficult. So, we used quadcopter to ``survey'' the campus using quadcopter
